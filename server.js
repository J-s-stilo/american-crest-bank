...
/*
=========================================================
NEW ROBUST CUSTOMER IDENTIFIER EXTRACTION
=========================================================
*/
...
async function resolveSupportCustomerId(identifier) {
  ...
  /*
  First try it as a customer identifier.
  */
  const customer =
  ...
  /*
  If the identifier is a support-message/ticket ID,
  resolve it directly to its customer.
  */
  const value =
    normalizeText(
      typeof identifier === 'object'
...
async function resolveSupportCustomerFromRequest(req) {
  ...
  /*
  First try customer identifiers.
  */
  ...
  /*
  Then try support/ticket identifiers.
  */
  for (const identifier of unique) {
    const customer =
...
async function handleAdminCredit(
  ...
  try {
    ...
    */
    ...
    /*
    Then try every customer identifier in body.
    */
    if (!userId) {
      userId =
    ...
    /*
    Extra fallback:
    if the frontend sends the selected customer as a
  ...
  async (_req, res) => {
    try {
      ...
      for (const row of result.rows) {
        ...
        /*
        Always expose the most recent message.
        */
...
async function handleSupportReply(
  ...
  try {
    ...
    /*
    First use the route ID if supplied.
    */
    if (routeId) {
      userId =
    ...
    /*
    Then inspect the entire request body.
    */
    if (!userId) {
      userId =
        await resolveSupportCustomerFromRequest(
          req
        );
    }
...
/*
Additional compatibility support routes.
*/
app.post(
